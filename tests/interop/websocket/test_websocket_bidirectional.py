...
async def test_bidirectional_communication():
    ...
    try:
        ...
        logger.debug("Starting JavaScript server...")
        ...
        await trio.sleep(3)
        logger.debug("JavaScript server started on port 8005")

        logger.debug("Setting up Python client...")
        ...
        logger.debug("Sending %d messages to JavaScript server...", len(test_messages))
