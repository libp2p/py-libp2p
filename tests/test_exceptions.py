...
from py_ipfs_lite.exceptions import BlockNotFoundError, PeerNotStartedError, PinNotFoundError, RoutingError
...
async def test_pin_not_found_error(started_peer):
    with pytest.raises(PinNotFoundError):
        started_peer.pin_store.remove_pin("QmYyQSo1c1Ym7orWxLYvCrM2EmxFTANf8wXmmE7DWjhx5N")
