...
async def test_bootnode_poisoning_attack():
    ...
    print(f"Permanent isolation risk: {isolation_rate * 0.6:.2%}")
...
async def main():
    ...
    for attack_name, result in results.items():
        ...
        print(f"[OK] {attack_display}: {result['attack_type']}")
