...
from libp2p.abc import MetadataValue
...
class TestMetadataValueTypeSafety:
    ...
    def test_valid_metadata_types(self):
        ...
        valid_values = [
            ...
            ("complex_dict", {"str": "value", "num": 42, "bool": True, "list": [1, 2], "null": None}),
            ("none_value", None)
        ]
    ...
    def test_peerstore_metadata_operations(self):
        ...
        for key, value in metadata_tests:
            ...
            assert retrieved == value, f"PeerStore failed for {key}: expected {value}, got {retrieved}"
    ...
    def test_metadata_error_handling(self):
        ...
        peerstore = PeerStore()
        non_existent_peer = ID.from_base58("QmNonExistentPeer1234567890123456789012345678")
...
class TestInvalidMetadataTypes:
    ...
    def test_non_json_serializable_types(self):
        ...
        problematic_values = [
            ...
            ("complex_type", complex(1, 2)),            # complex numbers not JSON serializable
...
class TestMetadataValueIntegration:
    ...
    def test_complete_peer_lifecycle(self):
        ...
        peerstore.put(peer_id, "stats", {"uptime": 7200, "messages_relayed": 3000, "connections": 30})
