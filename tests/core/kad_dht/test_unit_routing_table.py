...
class TestKBucket:
    ...
    def test_stale_peers(self, mock_host):
        ...
        bucket.peers[stale_peer.peer_id] = (stale_peer, current_time - 7200)  # 2 hours ago
...
class TestRoutingTable:
    ...
    @pytest.mark.trio
    async def test_add_peer_operations(self, mock_host, local_peer_id, sample_peer_info):
