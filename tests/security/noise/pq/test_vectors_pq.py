...
LEGACY: These vectors were generated for the X-Wing-based protocol.  The active
protocol has been migrated to Noise_XXhfs_25519+ML-KEM-768_ChaChaPoly_SHA256
(raw ML-KEM-768, no X25519 wrapper inside the KEM).  New ML-KEM-768 interop
vectors will be generated by the cross-language test harness (Task 3) and will
supersede this file.

This file is skipped until ML-KEM-768 interop vectors are available.
"""
...
pytestmark = pytest.mark.skip(
    reason=(
        "Legacy X-Wing interop vectors: protocol migrated to "
        "Noise_XXhfs_25519+ML-KEM-768_ChaChaPoly_SHA256. "
        "New vectors will be generated by the Task 3 interop harness."
    )
)
...
_VECTORS_PATH = Path(__file__).parents[3] / "fixtures" / "pqc-test-vectors.json"
