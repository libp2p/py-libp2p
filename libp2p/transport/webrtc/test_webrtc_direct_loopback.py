import logging
from multiaddr.protocols import add_protocol, Protocol, P_WEBRTC_DIRECT
import trio
...
from .gen_certhash import CertificateManager, create_webrtc_direct_multiaddr
...
async def build_host_and_transport(name: str):
    ...
    pubsub = Pubsub(
        host,
        GossipSub(protocols=["/libp2p/webrtc/signal/1.0.0"], degree=10, degree_low=3, degree_high=15),
        None,
    )
