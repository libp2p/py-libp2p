...
class UDPHolePuncher:
    ...
    async def punch_hole(self, target_ip: str, target_port: int, local_port: int = 0) -> Tuple[str, int]:
        """
        ...
        try:
            ...
            logger.info(f"UDP hole punched: {local_ip}:{local_port} -> {target_ip}:{target_port}")
