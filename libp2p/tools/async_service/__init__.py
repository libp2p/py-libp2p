...
This module has been replaced with libp2p.service which provides a modern
...
Please update your imports:
    ...
    NEW: from libp2p.service import Service, background_trio_service
...
warnings.warn(
    ...
    "Use 'from libp2p.service import ...' instead. "
