...
class Record(_message.Message):
    __slots__ = ("key", "value", "timeReceived", "author", "signature")
    ...
    author: bytes
    signature: bytes
    def __init__(self, key: _Optional[bytes] = ..., value: _Optional[bytes] = ..., timeReceived: _Optional[str] = ..., author: _Optional[bytes] = ..., signature: _Optional[bytes] = ...) -> None: ...
