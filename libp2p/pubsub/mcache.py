...
class MessageCache:
    ...
    control_msgs: dict[str, tuple[bytes, bytes]]
    ...
    def put(self, msg: rpc_pb2.Message) -> None:
        ...
        if mid in self.msgs:
            return
        self.msgs[mid] = msg
        self.control_msgs[format_control_message_id(mid)] = mid
    ...
    def get_by_control_message_id(
        self, control_id: str | bytes
    ) -> rpc_pb2.Message | None:
        control_id = validate_control_message_id(control_id)
    ...
    def shift(self) -> None:
        ...
        for entry in last_entries:
            ...
            self.control_msgs.pop(format_control_message_id(entry.mid), None)
