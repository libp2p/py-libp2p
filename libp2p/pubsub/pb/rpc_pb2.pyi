...
class RPC(google.protobuf.message.Message):
    ...
    TESTEXTENSION_FIELD_NUMBER: builtins.int
    ...
    @property
    def testExtension(self) -> global___TestExtension:
    ...
    def __init__(
        ...
        *,
        ...
        testExtension: global___TestExtension | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["control", b"control", "senderRecord", b"senderRecord", "testExtension", b"testExtension"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["control", b"control", "publish", b"publish", "senderRecord", b"senderRecord", "subscriptions", b"subscriptions", "testExtension", b"testExtension"]) -> None: ...
...
class ControlMessage(google.protobuf.message.Message):
    ...
    OBSERVE_FIELD_NUMBER: builtins.int
    UNOBSERVE_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def extensions(self) -> global___ControlExtensions:
    ...
    @property
    def observe(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ControlObserve]:
        """Topic Observation extension control messages."""

    @property
    def unobserve(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ControlUnobserve]: ...
    def __init__(
        self,
        *,
        ...
        extensions: global___ControlExtensions | None = ...,
        observe: collections.abc.Iterable[global___ControlObserve] | None = ...,
        unobserve: collections.abc.Iterable[global___ControlUnobserve] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["extensions", b"extensions"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["extensions", b"extensions", "graft", b"graft", "idontwant", b"idontwant", "ihave", b"ihave", "iwant", b"iwant", "observe", b"observe", "prune", b"prune", "unobserve", b"unobserve"]) -> None: ...

global___ControlMessage = ControlMessage

@typing.final
class ControlExtensions(google.protobuf.message.Message):
    ...
    TOPICOBSERVATION_FIELD_NUMBER: builtins.int
    TESTEXTENSION_FIELD_NUMBER: builtins.int
    topicObservation: builtins.bool
    """Set to true if the peer supports the Topic Observation extension."""
    testExtension: builtins.bool
    ...
    def __init__(
        self,
        *,
        topicObservation: builtins.bool | None = ...,
        testExtension: builtins.bool | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["testExtension", b"testExtension", "topicObservation", b"topicObservation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["testExtension", b"testExtension", "topicObservation", b"topicObservation"]) -> None: ...

global___ControlExtensions = ControlExtensions
...
@typing.final
class ControlObserve(google.protobuf.message.Message):
...
global___ControlObserve = ControlObserve

@typing.final
class ControlUnobserve(google.protobuf.message.Message):
...
global___ControlUnobserve = ControlUnobserve

@typing.final
class TestExtension(google.protobuf.message.Message):
...
global___TestExtension = TestExtension
