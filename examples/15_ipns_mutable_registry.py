...
async def main():
    ...
    v1_cid = await peer.add_node({"version": "1.0.0", "agents": ["summarizer", "classifier"]}, codec="dag-cbor")
    ...
    v2_cid = await peer.add_node({"version": "2.0.0", "agents": ["summarizer", "classifier", "retriever"]}, codec="dag-cbor")
