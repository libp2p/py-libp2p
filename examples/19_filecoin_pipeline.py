...
async def main():
    ...
    try:
        ...
        if os.path.exists(car_filename):
            ...
            logger.info(f"This file contains the complete verifiable inference history for root CID {root_cid}.")
            logger.info("It is perfectly formatted to be imported into a Filecoin Storage Provider (e.g. `lotus client import --car agent_inference_trace.car`).")
        else:
