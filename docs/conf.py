...
exclude_patterns = [
    ...
    # examples.pq_noise.rst is generated by sphinx-apidoc but never committed;
    # exclude it so Sphinx doesn't warn "not in any toctree" on local builds.
    "examples.pq_noise.rst",
]
