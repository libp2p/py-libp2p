...
| Gossipsub protocol negotiation set         | `node/modules/lp2p/pubsub.go:24`             | `src/libp2p/behaviour.rs:70`                              | `libp2p/filecoin/pubsub.py:24`                     | implemented | Preset exposes `/meshsub/2.0.0`, `1.2.0`, `1.1.0`, `1.0.0`.           |
